...
Code from Python ALMotion tutorials.
Creates a nice whole body movement, but perhaps more than needed.
...
def main(robotIP, PORT=9559):
    ...
    print "currentTf: ", currentTf
    # 1
    target1Tf  = almath.Transform(currentTf)
    print "target1Tf: ", target1Tf
    print "target1Tf type: ", type(target1Tf)
    print "target1Tf dir: ", dir(target1Tf)
    print "target1Tf.r2_c4 original: ", target1Tf.r2_c4
    target1Tf.r2_c4 += 0.08 # y
    print "target1Tf.r2_c4 new: ", target1Tf.r2_c4
    ...
    # This controls the speed, < 1 is too fast, causing instability. Default 1.5.
    coef       = 1.0
